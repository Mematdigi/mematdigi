...
const heroData = {
    ...
    titlePre: "Best SEO Company in India That Ranks Your Business on Google",
    desc: (
        <>
            As a trusted SEO company in India, our SEO experts deliver result-driven SEO services that improve rankings, increase organic traffic, and generate qualified leads for sustainable business growth.
        </>
    ),
    stats: [
    ...
    primaryCta: { text: "Get Free SEO Audit", url: "/contact-us" },
    form: {
        tag: "GET IN TOUCH",
        ...
        serviceOptions: [
            ...
            { value: "ecommerce", label: "Ecommerce SEO" },
