...
const heroData = {
    ...
    titlePre: "Best Email Marketing Company in India That Turns",
    titleHighlight: "Emails Into Revenue",
    titlePost: "",
    desc: (
        <>
            As a trusted email marketing company in India, we deliver result-oriented email marketing services that increase open rates, improve customer engagement, and generate consistent revenue. From email strategy and copywriting to automation, segmentation, and campaign management, we build email programs designed for long-term business growth.
        </>
    ),
    stats: [
    ...
    primaryCta: { text: "Get Free Email Audit", url: "/contact-us" },
    form: {
        tag: "GET IN TOUCH",
